...
```{r}
# Prepare network data for MRQAP. Create Trade graph based on vertex and edge_list
library(data.table)
...
```
```{r}
# After all models have been fitted:
saveRDS(mod0,         "models/mod0.rds")
saveRDS(mod1,         "models/mod1.rds")
saveRDS(mod_H1a,      "models/mod_H1a.rds")
saveRDS(mod_H1a_H2a,  "models/mod_H1a_H2a.rds")
```

```{r}
m_test <- readRDS("models/mod_H1a_H2a.rds")
class(m_test)
